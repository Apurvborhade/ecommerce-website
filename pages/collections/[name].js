        ...
        <div className='mb-20'>
            ...
            <div className='controls mt-20 flex justify-between items-center sticky z-10'>
                <div className='filter flex'>
                    {filters.map((item) => (
                        <button onClick={() => filterHandle(item)} className='mx-10 text-2xl flex items-center justify-center outline-none'>{item.title} <IoIosArrowDown  className='mx-3'/></button>
                    ))}
                </div>
